// -----------------------------------------------------------------------
// <copyright file="OpenAIToolCallingExtensionsTests.cs" company="Sassy Solutions">
...
namespace Compendium.Adapters.OpenAI.Tests.Tools;

public class OpenAIToolCallingExtensionsTests
{
    [Fact]
    public void WithTools_AddsToolsToAdditionalParameters()
    {
        ...
        added.Should().ContainKey(OpenAIToolCallingExtensions.ToolsKey);
        added[OpenAIToolCallingExtensions.ToolsKey].Should().BeSameAs(tools);
        added[OpenAIToolCallingExtensions.ToolChoiceKey].Should().Be("auto");
    }
    ...
    public void WithTools_WithoutToolChoice_OmitsToolChoiceKey()
    {
        ...
        // Assert
        updated.AdditionalParameters!.ContainsKey(OpenAIToolCallingExtensions.ToolChoiceKey).Should().BeFalse();
    }
    ...
    public void GetToolCalls_WrongMetadataShape_ReturnsEmpty()
    {
        ...
        var response = new CompletionResponse
        {
            ...
            {
                [OpenAIToolCallingExtensions.ToolCallsMetadataKey] = "not-a-list"
            }
        };
