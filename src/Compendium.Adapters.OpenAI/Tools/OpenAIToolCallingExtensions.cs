// -----------------------------------------------------------------------
// <copyright file="OpenAIToolCallingExtensions.cs" company="Sassy Solutions">
...
namespace Compendium.Adapters.OpenAI.Tools;
